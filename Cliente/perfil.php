...
// 1. SEGURIDAD: Si no hay sesión iniciada, lo mandamos al login
if (!isset($_SESSION['usuario_id'])) {
    header("Location: ../Visitante/IniciarSesion.php");
    exit;
}

// 2. RECUPERAR DATOS: Buscamos al usuario en la BD usando el ID de la sesión
        ...
        <header class="cabecera">
            <div class="container">
                ...
                <nav class="nav-bar">
                    ...
                    <!-- auth.js se encargará de marcar esto como activo o cambiar el texto -->
