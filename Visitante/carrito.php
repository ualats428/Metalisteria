    ...
    <div class="visitante-carrito">
        ...
        <main class="carrito-section">
            ...
            <div class="carrito-container">
                ...
                <!-- CASO 2: HAY PRODUCTOS (Bucle Dinámico) -->
                <?php else: ?>
                    <div class="carrito-items">
                        
                        <!-- BUCLE FOREACH: Genera una tarjeta por cada producto real -->
                                ...
                                <div class="item-details">
                                    ...
                                    <div class="item-actions">
                                        <div class="qty-selector">
                                            <!-- Botones visuales (para lógica funcional completa requeriría JS o links PHP) -->
                                        ...
                                        <a href="carrito.php?remove=<?php echo $id; ?>" class="btn-eliminar" aria-label="Eliminar producto" style="text-decoration: none; display: flex; align-items: center;">
                    ...
                    <div class="carrito-summary">
                        ...
                        <!-- BOTÓN DE COMPRA: Lógica solicitada -->
                        <?php if (isset($_SESSION['usuario_id'])): ?>
                            <!-- Si ya es cliente logueado -> Tramitar -->
                            <a href="../Cliente/TramitarPedido.php" class="btn-comprar" style="text-align:center; text-decoration:none; display:block;">
                                Comprar
                            </a>
                        <?php else: ?>
                            <!-- Si es visitante -> Eres Cliente -->
