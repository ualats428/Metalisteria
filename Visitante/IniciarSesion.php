...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 1. Comprobación en Base de Datos
    ...
    if ($usuario) {
        ...
        // A. Guardamos sesión en el Servidor (Seguridad)
        $_SESSION['usuario_id'] = $usuario['id'];
        $_SESSION['usuario_nombre'] = $usuario['nombre'];
        $_SESSION['usuario_rol'] = $usuario['rol'];

        // B. Definimos a dónde ir
        $destino = ($usuario['rol'] === 'admin') ? '../Administrador/indexAdmin.php' : '../Cliente/index.php';
        
        // C. TRUCO PARA AUTH.JS:
        // En lugar de redirigir directamente con PHP, imprimimos un script.
        // Esto guarda la "marca" en localStorage para que tu auth.js funcione,
...
<head>
    ...
    <!-- AQUI SI incluimos auth.js para que controle la cabecera -->
    <script src="auth.js"></script>
    <!-- IMPORTANTE: NO incluyas login.js, crea conflicto con el PHP -->
</head>
<body>
    <div class="visitante-login">
        
        <!-- CABECERA ESTÁTICA (Sin PHP dentro, tal como la querías) -->
        <!-- auth.js se encargará de modificarla si detecta el localStorage -->
