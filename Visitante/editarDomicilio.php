            ...
            <div class="address-card-container">
                ...
                <div class="blue-form-container">
                    ...
                    <div class="blue-form-row">
                        <label>Calle:</label>
                        <input type="text" value="Calle Recogidas" class="blue-input">
                    </div>

                    <div class="blue-form-row split">
                        <div class="blue-group">
                            <label>Número:</label>
                            <input type="text" value="12" class="blue-input short">
                        </div>
                        <div class="blue-group">
                            <label>Piso/Puerta:</label>
                            <input type="text" value="3º A" class="blue-input short">
                        </div>
                    </div>
                    ...
                    <div class="blue-form-row split">
                        <div class="blue-group">
                            ...
                            <input type="text" value="18001" class="blue-input short">
                        </div>
                        <div class="blue-group">
                            <label>Localidad:</label>
                            <input type="text" value="Granada" class="blue-input">
                        </div>
                    </div>
